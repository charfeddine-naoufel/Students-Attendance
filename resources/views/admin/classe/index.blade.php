                            ...
                            <table class="table table-sm table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr  >
                                        ...
                                        <td><strong>{{$classe->IdClasse}} </strong></td>
                                        <td><strong>{{$classe->IDNbrClasse}}</strong></td>
                                        <td><strong>{{$classe->AnneeScol}}</strong></td>
                                        <td><a href="{{ route('classes.show', $classe->IdClasse)}}"><span class="badge badge-pill {{ (strpos($classe->libeclassar,'أولى '))!=-1 ? 'badge-secondary' : 'badge-danger'}}  m-2">{{$classe->libeclassar}}</span></a> </td>
